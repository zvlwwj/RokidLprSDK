...
public class PlateModelView extends View {
    ...
    private int previewWidth = Constants.SCREEN_WIDTH;
    private int previewHeight = Constants.SCREEN_HEIGHT;
    private Rect baseRect = new Rect(20, 20, previewWidth - 20, previewHeight - 20);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (lprModel != null && lprModel.size() > 0) {
            ...
            paint.setStrokeWidth(20);
            drawBaseRect(canvas, baseRect, paint, LARGE);
        }
        isDrawing = false;
    }
